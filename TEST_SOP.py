...
def args2dict(args):
    ...
    model_params = {"embedding_dim": args.embedding_dim, "sqrt_embedding_dim": args.sqrt_embedding_dim,
                    ...
                    "dual_decoder": args.dual_decoder, "clean_cache": args.clean_cache, "succ_attention_bias": args.succ_attention_bias,
                    "gumbel": args.gumbel, "pairwise_merge": args.pairwise_merge.split(",") if isinstance(args.pairwise_merge, str) else args.pairwise_merge, "which_feature": args.which_feature,
                    # improvement
...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_dataset', type=str, nargs='+', default =["sop50_uniform_prec0.2_geom0.3.pkl"]) # ["tsptw100_da_silva_uniform_varyN.pkl"]
    ...
    parser.add_argument('--best_solution_path', type=str, default=None) #tw50_pip_best_solution") #"tw50_pip_best_solution.pkl")
    parser.add_argument('--refinement_history_path', type=str, default=None) #"tw50_pip_history") #"")
    ...
    parser.add_argument('--test_dataset', type=str, default=["sop50_uniform_prec0.2_geom0.8_bal0.0.pkl"])
    ...
    # load
    # parser.add_argument('--checkpoint', type=str, default="/home/jieyi/unified_solver_1/results/20251119_181156_SOP50_0p2_0p3_rmPOMOstart_Mask_unifiedEnc_withRNN_GroupBaseline_ImprTop10Qual_Impro5Val20_AMP_noregnobonus_Rmx1Insbefore_FeatbothAttn/epoch-1000.pt")
    # parser.add_argument('--checkpoint', type=str, default="/home/jieyi/unified_solver_1/results/epoch-1000.pt")
    parser.add_argument('--checkpoint', type=str, default="/home/jieyi/unified_solver_1/results/20251119_181750_SOP50_0p2_0p8_rmPOMOstart_Mask_construction_only_FeatbothAttn/epoch-1000.pt")
    ...
    parser.add_argument('--pairwise_merge', type=str, default="feature,attention",
                        help='Comma-separated list of modes: feature,embedding,attention. Can use multiple modes together, e.g., "feature,embedding" or ["feature","attention"]')
    ...
    parser.add_argument('--validation_batch_size', type=int, default=500)
    ...
    # note = "_VRPBLTW100_rmPOMOstart_Soft_unifiedEnc_GroupBaseline_ImprREALTop3Qual_Impro5Val20_AMP_warmstart_noregnobonus_Rmx1InsAfterN2S_diversity_IL_NonLinear_decay10_0001_co10_from3100top1"  #
    # note = "debug"
    note = "test"
    if "debug" in note:
