...
if __name__ == "__main__":
    ...
    # parser.add_argument('--POMO_checkpoint', type=str, default="./test/TSPTW100/20240928_224256_TSPTW100_Hard_varyN_pip-d_m0/epoch-10000.pt")
    parser.add_argument('--POMO_checkpoint', type=str, default="/home/jieyi/unified_solver_1/test/TSPTW50/epoch-10000.pt")
