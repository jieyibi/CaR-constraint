...
if __name__ == "__main__":
    ...
    # env_params
    parser.add_argument('--problem', type=str, default="TSPDL", choices=["CVRP", "TSPTW", "TSPDL", "VRPBLTW"])
    ...
    parser.add_argument('--val_dataset', type=str, nargs='+', default =["tspdl50_hard.pkl"]) # ["tsptw100_da_silva_uniform_varyN.pkl"]
    ...
    note = "_TSPDL50Hard_rmPOMOstart_Soft_unifiedEnc_GroupBaseline_ImprTop10Qual_Impro5Val20_AMP_noregnobonus_kopt_diversity_IL"
