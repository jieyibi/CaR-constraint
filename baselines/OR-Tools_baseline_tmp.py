...
def create_data_model(depot, loc, demand=None, capacity=None, route_limit=None, service_time=None, tw_start=None, tw_end=None, grid_size=1, problem="CVRP"):
    """
...
if __name__ == '__main__':
    ...
    for dataset_path in opts.datasets:
        ...
        def run_func(args):
            ...
            depot, loc, demand, capacity, route_limit, service_time, tw_start, tw_end, all_loc = None, None, None, None, None, None, None, None, None
