...
def create_data_model(depot, loc, demand, capacity, route_limit=None, service_time=None, tw_start=None, tw_end=None, draft=None, grid_size=1, problem="CVRP"):
    """
...
def print_solution(data, manager, routing, assignment, problem="CVRP", log_file=None):
    ...
    def calc_vrp_cost(depot, loc, tour, problem):
        ...
        if problem in ["CVRP", "VRPB", "VRPL", "VRPTW", "VRPBL", "VRPLTW", "VRPBTW", "VRPBLTW", "TSPDL"]:
...
def solve_or_tools_log(directory, name, depot, loc, demand, capacity, route_limit=None, service_time=None, tw_start=None, tw_end=None, draft=None,
    ...
    search_parameters.local_search_metaheuristic = (routing_enums_pb2.LocalSearchMetaheuristic.GUIDED_LOCAL_SEARCH)  # GUIDED_LOCAL_SEARCH
...
if __name__ == '__main__':
    ...
    parser.add_argument('--problem', type=str, default="TSPDL", choices=["TSPDL"])
    parser.add_argument("--datasets", nargs='+', default=["../data/TSPDL/tspdl50_q75_uniform_fsb.pkl", ], help="Filename of the dataset(s) to evaluate")
    ...
    for dataset_path in opts.datasets:
        ...
        filtered_cost = [x for x,_,_ in results if x is not None]
